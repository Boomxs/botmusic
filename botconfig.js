module.exports = {
  Admins: ["889775599365804062"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/8TNZzTjrvW", // Support Server Link
  Token: process.env.Token || "MTA5MDk0NTYyMjcyNDU3NTMwMg.G3fppO.ATFEMIaJteo3TijY62k8OOZcUCBWcOtxQyirIQ", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1090945622724575302", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "eJOskMp-QGJ_H_qLdM5kATyRa2pigtvs", // Discord Client Secret
  ...
  Lavalink: {
    ...
    host: "fsn.lavalink.alexanderof.xyz", //- The host name or IP of the lavalink server.
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "1a1a17a964324fd8b865f0b01dd348ea", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "0a3dacdd1adb41c5a2ff8a4283212263", // Spotify Client Secret
  },
};
